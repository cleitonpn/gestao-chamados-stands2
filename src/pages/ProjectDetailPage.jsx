...
const ProjectDetailPage = () => {
  ...
  const db = getFirestore(); // ✅ usa app já inicializada no projeto
  ...
  const ticketMetrics = useMemo(() => {
    ...
    const notOpenStatuses = new Set([
      'concluido', 'concluído', 'arquivado', 'fechado', 'resolvido', 'cancelado',
    ]);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Diário – FORM (entre Info Básicas e Cronograma) */}
            <Card>
          ...
          <div className="space-y-6">
            ...
            {/* Observações do Projeto (lista do diário) — na sidebar */}
            <Card>
